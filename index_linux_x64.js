const { IEC104Client } = require('./builds/linux_x64/addon_iec60870');
...
async function main() {
    ...
    client.connect('192.168.0.111', 2404, 'client number 1', {
        originatorAddress: 1,
        k: 12,
        w: 8,
        t0: 30,
    ...
    /*client2.connect('192.168.0.102', 2404, 'client number 2', {
        originatorAddress: 1,
        k: 12,
        w: 8,
        t0: 30,
